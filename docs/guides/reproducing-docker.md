...
`docs/guides/reproducing-native.md`). The flake pins LibreLane 3.0.0 with a
...
- `scripts/env/run_docker_iic.sh` - launcher with mount + env knobs.
- `docs/guides/reproducing-native.md` - the reference build path.
