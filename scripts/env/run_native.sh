...
#
# Full walkthrough in docs/guides/reproducing-native.md. This script just
# chains the three commands so you can type one thing:
#
#   scripts/env/run_native.sh
#
...
if ! command -v nix-shell >/dev/null 2>&1; then
    ...
    echo "See docs/guides/reproducing-native.md for Nix install instructions." >&2
    exit 1
fi
