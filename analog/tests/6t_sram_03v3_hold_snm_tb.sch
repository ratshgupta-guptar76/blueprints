...
.end
"}
C {vsource.sym} 1310 -770 0 0 {name=Vin value=0 savecurrent=false}
C {gnd.sym} 1310 -740 0 0 {name=l4 lab=0}
C {opin.sym} 1310 -810 3 0 {name=p9 lab=Vin
W=0.22u}
