...
C {vsource.sym} 480 -250 0 0 {name=VWL1 value=3.3 savecurrent=false}
...
W=0.22u}
C {vsource.sym} -40 150 0 0 {name=V_BL value=3.3 savecurrent=false}
C {opin.sym} -40 100 1 1 {name=VHIGH lab=vhigh
W=0.22u}
C {gnd.sym} -40 200 0 0 {name=V_BL2 lab=0}
C {ipin.sym} -670 10 1 1 {name=p14 lab=vhigh
W=0.22u}
C {ipin.sym} 180 10 1 1 {name=p15 lab=vhigh
W=0.22u}
